    ...
    content: [
      {
        ...
        img: null,
        desc: {
          en: "Where I post my videos.",
          ar: "حيث أنشر فيديوهاتي.",
        },
        tag: { en: "Video Editing", ar: "مونتاج فيديو" },
        alt: { en: "YouTube channel - video thumbnail", ar: "قناة يوتيوب - صورة مصغرة" },
      },
      {
        slug: "instagram",
        name: "Instagram",
        url: "https://www.instagram.com/teddzfr/",
        img: null,
        desc: {
          en: "Where I post my photos and updates.",
          ar: "حيث أنشر صوري وتحديثاتي.",
        },
        tag: { en: "Short-form", ar: "محتوى قصير" },
        alt: { en: "Instagram profile - photo feed", ar: "ملف Instagram - موجز صور" },
      },
    ],
  },
  t: {
    en: {
      ...
      "testimonials.note1": "Building my first client projects.",
      "testimonials.note2": "I'm currently working with a few businesses to build websites for free while I grow my portfolio. Testimonials will appear here as projects are completed.",
      "review.formTitle": "Leave a review",
      "review.formSub": "Worked with me? Tell others what I helped you with. Your review appears after I approve it.",
      "review.name": "Your name",
      "review.rating": "Your rating",
      "review.desc": "What did I help you with?",
      "review.avatar": "Profile logo (optional, up to 5 MB)",
      "review.images": "Attach images (optional, up to 5 MB each)",
      "review.video": "Attach a video (optional, up to 10 MB)",
      "review.submit": "Submit review",
      "review.success": "Thanks! Your review was sent and will appear once approved.",
      "review.noFile": "No file chosen",
      "review.noFiles": "No files chosen",
      "review.filesChosen": "files chosen",
      ...
      "support.sub": "Everything here stays free. If my tools or configs helped you, a small tip keeps the coffee flowing.",
    ...
    ar: {
      ...
      "testimonials.note1": "أبني مشاريع عملائي الأولى.",
      "testimonials.note2": "أعمل حاليًا مع بعض الشركات لبناء مواقع ويب مجانًا بينما أنمّي محفظتي. ستظهر الشهادات هنا مع اكتمال المشاريع.",
      "review.formTitle": "اترك تقييمًا",
      "review.formSub": "عملت معي؟ أخبر الآخرين بما ساعدتك فيه. سيظهر تقييمك بعد أن أوافق عليه.",
      "review.name": "اسمك",
      "review.rating": "تقييمك",
      "review.desc": "بماذا ساعدتك؟",
      "review.avatar": "شعار الصورة الشخصية (اختياري، حتى 5 م.ب)",
      "review.images": "إرفق صورًا (اختياري، حتى 5 م.ب لكل صورة)",
      "review.video": "إرفق فيديو (اختياري، حتى 10 م.ب)",
      "review.submit": "إرسال التقييم",
      "review.success": "شكرًا! تم إرسال تقييمك وسيظهر بعد الموافقة عليه.",
      "review.noFile": "لم يتم اختيار ملف",
      "review.noFiles": "لم يتم اختيار ملفات",
      "review.filesChosen": "ملفات تم اختيارها",
      ...
      "contact.sub": "لديك مشروع أو سيرفر تريد تجهيزه، أو تريد فقط إلقاء التحية؟ بريدي مفتوح.",
      "contact.cta": "راسلني",
      "support.eyebrow": "دعم",
      "support.title": "ادعني على قهوة.",
      "support.sub": "كل شيء هنا يبقى مجانيًا. إن كانت أدواتي أو إعداداتي ساعدتك، ففنجان قهوة يُبقي الليل يعمل.",
